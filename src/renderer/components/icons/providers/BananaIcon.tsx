...
const BananaIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} height="24" viewBox="0 0 36 36" width="24" xmlns="http://www.w3.org/2000/svg" style={{ flex: '0 0 auto', lineHeight: 1 }}>
    <title>Banana</title>
    <path fill="#FFE8B6" d="M28 2c2.684-1.342 5 4 3 13c-1.106 4.977-5 9-9 12s-11-1-7-5s8-7 10-13c1.304-3.912 1-6 3-7z" />
    <path fill="#FFD983" d="M31 8c0 3-1 9-4 13s-7 5-4 1s5-7 6-11s2-7 2-3z" />
    ...
    <path fill="#A6D388" d="M26 35h-4c-2 0-3 1-4 1s-2-2 0-2s4 0 5-1s5 2 3 2z" />
    <circle fill="#3E721D" cx="18" cy="35" r="1" />
    <path fill="#FFCC4D" d="M32.208 28S28 35 26 35h-4c-2 0 0-1 1-2s5 0 5-6c0-3 4.208 1 4.208 1z" />
    <path fill="#FFE8B6" d="M26 19c3 0 8 3 7 9s-5 7-7 7h-2c-2 0-1-1 0-2s4 0 4-6c0-3-4-7-6-7c0 0 2-1 4-1z" />
