...
const PrimarySidebar: React.FC<PrimarySidebarProps> = ({ activeView, onSelectView, onOpenSettings }) => {
  return (
    <aside className="jbp-visual-workbench-rail flex w-[96px] shrink-0 flex-col border-r px-2.5 py-4">
            ...
            <button
              ...
              className={`group relative flex flex-col items-center gap-1.5 rounded-[18px] px-1.5 py-2.5 text-center transition-colors duration-200 ${
                isActive
                  ...
                  : 'text-secondary hover:bg-surface-raised/70 hover:text-foreground'
              }`}
      ...
      <div className="mt-3.5 flex shrink-0 flex-col gap-2.5">
        <button
          ...
          className="flex flex-col items-center gap-1.5 rounded-[18px] px-1.5 py-2.5 text-secondary transition-colors hover:bg-surface-raised/70 hover:text-foreground"
        >
        ...
        <div className="px-2.5 py-2 text-center opacity-90">
          <div className="flex items-center justify-center">
            <QingShuBrandMark
              className="relative flex h-6 w-6 items-center justify-center overflow-hidden rounded-full bg-primary shadow-subtle ring-1 ring-white/45"
              iconClassName="text-[12px] font-semibold leading-none text-primary-foreground"
            />
          </div>
          <div className="mt-2 text-[11px] font-semibold leading-4 tracking-[0.08em] text-primary">
            {i18nService.t('workbenchBrandLine1')}
          </div>
          <div className="mt-1 text-[11px] font-medium leading-4 text-secondary">
