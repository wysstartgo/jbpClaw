...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    authQingShuManagedSessionExpired: '青数能力登录已失效，请重新登录后继续使用青数内置 Agent / Skill。',
    authLoginWelcomeTitle: '欢迎回来',
    authLoginWelcomeSubtitle: '灵工打卡',
    authEnterUsernameAndPassword: '请输入用户名和密码',
    authSettingsTitle: '登录认证',
    authSettingsDescription: '当前项目默认使用青数认证。青数内置模型、图片生成、SkillHub 与套餐额度都使用这里的后端地址。',
    authBackendQtb: '青数认证（账密 + 飞书）',
    authQtbApiBaseUrl: '青数后台 API 地址',
    ...
    browserBlockedHostnamesDescription: 'QingShuClaw 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 QingShuClaw 不会打开此 URL',
    preventSleep: '防止休眠',
  ...
  en: {
    ...
    authQingShuManagedSessionExpired: 'Your QingShu capability session has expired. Sign in again to continue using QingShu managed agents and skills.',
    ...
    authSettingsDescription: 'This project uses QingShu auth by default. Managed models, image generation, SkillHub, and quota checks all use this backend URL.',
    authBackendQtb: 'QingShu auth (password + Feishu)',
    authQtbApiBaseUrl: 'QingShu backend API URL',
    ...
    browserBlockedHostnamesDescription: 'QingShuClaw will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means QingShuClaw will not open this URL',
