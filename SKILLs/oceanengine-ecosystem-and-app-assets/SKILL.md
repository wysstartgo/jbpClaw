---
name: oceanengine-ecosystem-and-app-assets
description: 适用于 OceanEngine 中与“应用生态、小程序与渠道资产”相关的需求，优先使用本域 Tool-Range 白名单处理任务，而不是直接暴露全量 AD MCP 工具。
---
...
覆盖应用管理、试玩素材、字节/微信小程序、小游戏、穿山甲流量包与订阅推送账户。
...
- 管理安卓应用、母包、快应用与试玩素材
- 创建与更新字节/微信小程序、小游戏资产
- 管理穿山甲流量包、订阅推送账户和平台生态资产

示例任务：
- 帮我查看应用、小程序、小游戏和试玩资产的现状。
- 帮我判断某个生态资产是该新建、更新还是仅查询。
- 帮我整理穿山甲流量包和订阅账户的配置状态。

非目标：
- 不负责评论运营、代理商结算与通用报表分析
- 不负责线索表单和商品库商品管理
