---
name: oceanengine-catalog-and-dpa
description: 适用于 OceanEngine 中与“商品库、资产共享与 DPA”相关的需求，优先使用本域 Tool-Range 白名单处理任务，而不是直接暴露全量 AD MCP 工具。
---
...
示例任务：
- 帮我查看商品库、DPA 商品和共享关系的整体状态。
- 帮我查询某个商品或商品库的投放条件与关联信息。
- 帮我判断这批商品资产应更新、共享还是下线。
