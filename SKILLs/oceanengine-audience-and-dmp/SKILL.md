---
name: oceanengine-audience-and-dmp
description: 适用于 OceanEngine 中与“人群包与 DMP 数据资产”相关的需求，优先使用本域 Tool-Range 白名单处理任务，而不是直接暴露全量 AD MCP 工具。
---
...
示例任务：
- 帮我查看当前定向包和 DMP 人群资产，并做分类。
- 帮我判断这个人群包应该复制、推送还是发布。
- 帮我检查数据源与人群包是否存在断链或状态异常。
