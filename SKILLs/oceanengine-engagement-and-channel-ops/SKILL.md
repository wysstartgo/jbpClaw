---
name: oceanengine-engagement-and-channel-ops
description: 适用于 OceanEngine 中与“评论运营与渠道增效”相关的需求，优先使用本域 Tool-Range 白名单处理任务，而不是直接暴露全量 AD MCP 工具。
---
...
覆盖评论、屏蔽词、抖音内容互动、DOU+、蓝海、否定词与渠道增效类工具。

当前域工具数：`53`

典型场景：
- 拉评论、回复评论、隐藏评论与管理屏蔽词
- 做 DOU+、蓝海、优词提量、否定词等渠道优化
- 检查灰度、白名单、兴趣行为与互动运营能力

示例任务：
- 帮我查看评论区状态，并整理出需要回复或隐藏的项。
- 帮我检查 DOU+、蓝海和优词提量配置的可优化点。
- 帮我梳理屏蔽词、否定词和灰度能力的当前状态。
