---
name: oceanengine-agent-finance-and-organization
description: 适用于 OceanEngine 中与“代理商、组织与结算”相关的需求，优先使用本域 Tool-Range 白名单处理任务，而不是直接暴露全量 AD MCP 工具。
---
...
覆盖代理商账户、组织结构、转账、退款、开票、商务结算与组织内账户关系。
...
示例任务：
- 帮我查询代理商下广告主和组织关系，并指出关键账户。
- 帮我梳理最近的转账、退款或开票记录，并总结异常。
- 帮我核对公司主体、组织账户和业务实体的对应关系。

非目标：
- 不直接负责项目、广告、素材或线索业务执行
- 不负责通用广告报表分析与创意管理
