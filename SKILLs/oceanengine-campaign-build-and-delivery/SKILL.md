---
name: oceanengine-campaign-build-and-delivery
description: 适用于 OceanEngine 中与“项目、广告与投放搭建”相关的需求，优先使用本域 Tool-Range 白名单处理任务，而不是直接暴露全量 AD MCP 工具。
---
...
示例任务：
- 帮我基于当前目标搭一个项目和广告结构草案。
- 帮我检查这个项目的预算、出价和关键词配置是否合理。
- 帮我列出当前投放结构中可调整的项目、广告和预算组。
